...
export const environment = {
  ...
  //maReportesTr4: urls.moduloInternoAdministracion + '/reportetr4',
  maBitacoraTr4: urls.moduloInternoParametrizacion + '/bitacoratr4',

  maParametrizacion: urls.moduloInternoParametrizacion + '/parametrizacion',
  maParametrizacionflujo: urls.moduloInternoParametrizacion + '/parametrizacionflujo',
};
